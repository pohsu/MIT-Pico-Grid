...
int main( void )
{
    ...
    _Q16 QoffsetV0 = _Q16ftoi(383), QoffsetV1 = _Q16ftoi(383), QoffsetV2 = _Q16ftoi(383);  //Offset to correct 1.25V bias
    _Q16 QgainV0 = _Q16ftoi(0.90909), QgainV1 = _Q16ftoi(0.867052), QgainV2 = _Q16ftoi(0.872093);  //Offset to correct 1.25V bias
