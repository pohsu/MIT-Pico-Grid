...
int main( void )
{
    ...
    _Q16 errorpre2 = 0;
    _Q16 outputpre2 = 0;
    _Q16 error2, output2, speed_rads, speed_Hz = _Q16ftoi(0);
    ...
    _Q16 offset3 = _Q16ftoi(10);
    _Q16 Qtemp = 0;
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Q16 Constant">
    _Q16 Q1_60 = _Q16ftoi(0.01666666);  // 1/62
    ...
    while(1)
    {
        if (flag_main)
        {
            ...
            duty2Q16 = _Q16mac(fieldvoltage, _Q16ftoi(350), 0);
            Duty2 = duty2Q16 >> 16;
            ...
            Iref = output2;
            Io = _Q16ftoi(I[0])-_Q16ftoi(74); //Remove offset
            Io = _Q16mac(Io, Q1_60, 0);
            error1 = Iref - Io;
            //Y(k) = u0*U(k)+u1*U(k-1)+y1*Y(k-1)
            ...
            if (Io < 0)
            {
                Io = _Q16mac(Io, _Q16ftoi(-1), 0);
            }
            if (QVd < 0)
            {
                QVd = _Q16mac(QVd, _Q16ftoi(-1), 0);
            }
//            VIW[0] = speed_rads>>16;
            //VIW[1] = Qy2[0]>>16; //Voltage Magnitude
            //VIW[1] = QVd>>16; //Voltage Magnitude
//            VIW[1] = I[0]; //Voltage Magnitude
//            VIW[2] = QVmag>>16;
            VIW[0] = voltageref; //Voltage Magnitude
            VIW[1] = speed_Hz>>16; //Voltage Magnitude
            VIW[2] = 2;
            kk++;
            ctr = ctr+1;
