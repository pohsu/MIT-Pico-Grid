...
int main( void )
{
    ...
    _Q16 Kp02 = _Q16ftoi(0.005);            //0.4
    _Q16 Ki02_default = _Q16ftoi(0.00005); //gain*T 0.04
    ...
    _Q16 QI = _Q16ftoi(14); // PI controller I gain normalized to QoffsetVx gain*T 28000*0.0005
    ...
    //DQ Transformation I - Calibration done by Mike for PMU2 and Generic Control 2 on 3/25/2016
    _Q16 QoffsetI0 = _Q16ftoi(495), QoffsetI1 = _Q16ftoi(495);
    _Q16 QgainI0 = _Q16ftoi(0.009318), QgainI1 = _Q16ftoi(0.009318);
    ...
    while(1)
    {
        if (flag_main)
        {
            dt2 = TMR4;
            TMR4 = 0;
            Qdummy = _Q16mac(_Q16ftoi(dt2/35), QsampT0, 0);
            Qtest0 = Qdummy;
