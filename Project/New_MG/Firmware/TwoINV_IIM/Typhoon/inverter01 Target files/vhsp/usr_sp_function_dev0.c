...
unsigned int _3ph_inverter_1_pwm_modulator__channels[3] = {3, 4, 5};
double _3ph_inverter_1_pwm_modulator__limited_in[3];
unsigned int _3ph_inverter_1_pwm_modulator__update_mask;

unsigned int _3ph_inverter_2_pwm_modulator__channels[3] = {0, 1, 2};
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _3ph_inverter_1_pwm_modulator__update_mask = 56;
    ...
    _3ph_inverter_2_pwm_modulator__update_mask = 7;
