...
{
	static float32 IL_PID_states1[2] = {0, 0}, IL_PID_states2[2] = {0, 0};
	static float32 LPF_damper_states1[2] = {0}, LPF_damper_states2[2] = {0};


	Droop_control(enable, Droop, S1, &control_states1, &meas_states1);
	IIM(enable, Xm[0], S1, &control_states1, &meas_states1);
	...
	Droop_control(enable, Droop, S2, &control_states2, &meas_states2);
	IIM(enable, Xm[1], S2, &control_states2, &meas_states2);
	Damper(enable, &control_states2, &meas_states2, LPF_damper_states2);
	IL_control(enable, &control_states2, &meas_states2, IL_PID_states2);

//	uDACA(1.0f, I_NOM*1.5f);
//	uDACB(meas_states1.VC_dq[0], V_NOM*1.5f);
//	DACC(control_states1.damper_dq[0], I_NOM*3.0f);
