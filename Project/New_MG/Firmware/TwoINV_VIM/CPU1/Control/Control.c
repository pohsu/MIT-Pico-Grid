...
//	control_states1.IL_dq_ref[0] = 17.0f;
//	control_states1.IL_dq_ref[1] = 0.0f;
	...
	Virtual_component(enable, Xm[1], S2, &control_states2, &meas_states2);
...
//	control_states2.IL_dq_ref[0] = 8.0f;
//	control_states2.IL_dq_ref[1] = 0.0f;
