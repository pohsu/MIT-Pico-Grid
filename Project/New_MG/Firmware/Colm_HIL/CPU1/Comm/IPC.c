...
//	sizeofdata_rx = array[0];
	...
	{
		enable = 0; //stop PWM
		GpioDataRegs.GPCSET.bit.GPIO83 = 1; //LED6
		GpioDataRegs.GPCCLEAR.bit.GPIO79 = 1; //LED4
	} 

	if (array[1] == START){
		enable = 1;
		GpioDataRegs.GPCCLEAR.bit.GPIO83 = 1; //LED6
		GpioDataRegs.GPCSET.bit.GPIO79 = 1; //LED4
	}
