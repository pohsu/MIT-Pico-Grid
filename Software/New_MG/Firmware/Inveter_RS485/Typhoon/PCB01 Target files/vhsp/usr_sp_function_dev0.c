...
void ReInit_user_sp_cpu_dev0() {
    ...
    HIL_OutInt32(HIL_PM_DI_ADDR + _3ph_inverter_1_pwm_modulator__channels[0], 3);
    ...
    HIL_OutInt32(HIL_PM_DI_ADDR + _3ph_inverter_1_pwm_modulator__channels[1], 4);
    ...
    HIL_OutInt32(HIL_PM_DI_ADDR + _3ph_inverter_1_pwm_modulator__channels[2], 5);
