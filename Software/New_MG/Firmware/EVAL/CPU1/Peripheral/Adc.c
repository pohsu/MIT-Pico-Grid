...
//	AdcaRegs.ADCINTFLGCLR.bit.ADCINT1 = 1; //make sure INT1 flag is cleared
	...
	AdcaRegs.ADCSOC3CTL.bit.ACQPS = ACQPS_SIZE; //sample window:adding buffer since ADAC is the source for interrupt
	AdcaRegs.ADCSOC3CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB
	...
	AdcbRegs.ADCSOC4CTL.bit.CHSEL = 4;  //SOC4 will convert ADCINB4
	AdcbRegs.ADCSOC4CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	...
	AdcbRegs.ADCSOC5CTL.bit.CHSEL = 5;  //SOC5 will convert ADCINB5
	AdcbRegs.ADCSOC5CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	AdcbRegs.ADCSOC5CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB

	//Output Current
	AdcaRegs.ADCSOC6CTL.bit.CHSEL = 14;  //SOC6 will convert ADCIN14
	AdcaRegs.ADCSOC6CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	AdcaRegs.ADCSOC6CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB

	AdcdRegs.ADCSOC6CTL.bit.CHSEL = 0;  //SOC6 will convert ADCIND0
	AdcdRegs.ADCSOC6CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	AdcdRegs.ADCSOC6CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB

	AdcaRegs.ADCSOC7CTL.bit.CHSEL = 15;  //SOC7 will convert ADCIN15
	AdcaRegs.ADCSOC7CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	AdcaRegs.ADCSOC7CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB

	AdcdRegs.ADCSOC7CTL.bit.CHSEL = 1;  //SOC7 will convert ADCIND1
	AdcdRegs.ADCSOC7CTL.bit.ACQPS = ACQPS_SIZE; //sample window
	AdcdRegs.ADCSOC7CTL.bit.TRIGSEL = 6; //trigger on ePWM1 SOCB

	AdcaRegs.ADCINTSEL1N2.bit.INT1SEL = 0x7; //end of SOC7 will set INT1 flag
	AdcaRegs.ADCINTSEL1N2.bit.INT1E = 1;   //enable INT1 flag
	AdcaRegs.ADCINTFLGCLR.bit.ADCINT1 = 1; //make sure INT1 flag is cleared
	#endif
