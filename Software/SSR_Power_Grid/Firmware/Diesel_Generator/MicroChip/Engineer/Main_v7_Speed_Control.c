...
unsigned long I[3], Iac[3];              // Measured Currents
...
//    while (OSCCONbits.LOCK != 1);
    ...
    PR1 = 8750;        // Timer1 period TCKPS 0b01 & PR1 8750 - 1kHz
    TMR1=0;             //Timer1 reset
    // </editor-fold>
    ...
    AD1CON1bits.SSRCG = 0;          // Auto conversion
    ...
    AD1CHS123bits.CH123SB0 = 1;     // CH1 - AN0, CH2 - AN1, CH3 - AN2
...
int main( void )
{
    ...
    _Q16 Ki01_default = _Q16ftoi(5*0.001); //gain*T + 1Khz - 1ms
    ...
    _Q16 Ki02_default = _Q16ftoi(4*0.01); //gain*T - 100HZ - 10ms
    _Q16 Ki02 = Ki02_default; //gain*T
    _Q16 integ02, integ02_pre = 0;

    //Exciter Cuurent Controller #3
    _Q16 Iref3 = _Q16ftoi(0);  //Iref
    _Q16 Io3, error3, output3, duty3Q16 = _Q16ftoi(0);
    _Q16 Kp03 = _Q16ftoi(1);
    _Q16 Ki03_default = _Q16ftoi(4*0.001); //gain*T + 1Khz - 1ms
    ...
    _Q16 QP = _Q16ftoi(60); // PI controller P gain normalized to QoffsetVx 60
    _Q16 QI = _Q16ftoi(14000); // PI controller I gain normalized to QoffsetVx 14000
    _Q16 Qomega = 0, Qomega_init = _Q16ftoi(120*pi); // freq rads/s;
    _Q16 QsampT = _Q16ftoi(0.001); // Sampling Time - 1kHz - 1ms
    ...
    _Q16 QVd,QVq = 0; // DQ0 voltage

    //DQ Transformation I - Calibration done by Mike for PMU2 and Generic Control 2 on 11/16 2015
    _Q16 QoffsetI0 = _Q16ftoi(500), QoffsetI1 = _Q16ftoi(500);
    _Q16 QgainI0 = _Q16ftoi(0.009283), QgainI1 = _Q16ftoi(0.009283);
    _Q16 QIa,QIb,QIc = 0; // Three phase voltage
    _Q16 QId,QIq = 0; // DQ0 voltage

    // Angle Computation #1
    _Q16 QIin1 = 0, QIout1 = 0, QIout_pre1 = 0; // Integrator1 output
    _Q16 Qtheta = 0; // theta

    // Z filter for D Voltage Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #2
    _Q16 QIin2, QIout2, QIout_pre2 = 0;
    _Q16 Qa20 = _Q16ftoi(0.09516), Qb20 = _Q16ftoi(0.9048);
    _Q16 QVdf = 0;

    // Z filter for Q Voltage Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #5
    _Q16 QIin5, QIout5, QIout_pre5 = 0;
    _Q16 Qa50 = _Q16ftoi(0.09516), Qb50 = _Q16ftoi(0.9048);
    _Q16 QVqf = 0;

    // Z filter for D Current Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #3
    _Q16 QIin3, QIout3, QIout_pre3 = 0;
    _Q16 Qa30 = _Q16ftoi(0.09516), Qb30 = _Q16ftoi(0.9048);
    _Q16 QIdf = 0;

    // Z filter for Q Current Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #3
    _Q16 QIin4, QIout4, QIout_pre4 = 0;
    _Q16 Qa40 = _Q16ftoi(0.09516), Qb40 = _Q16ftoi(0.9048);
    _Q16 QIqf = 0;

    // Angle Calibration
    _Q16 QthetaC = _Q16ftoi(-0.0997);
    _Q16 QIdc, QIqc = 0;

    // P & Q
    _Q16 QPower, QReactive = 0;
    // </editor-fold>
    ...
    while(1)
    {
        if (flag_main)
        {
            ...
            Vref4 =  _Q16ftoi(ref1);
            error4 = Vref4 - QVdf;
            Kp04 = _Q16mac(_Q16ftoi(ref2), _Q16ftoi(0.0177), 0);
            ...
            // <editor-fold defaultstate="collapsed" desc="DQ Transformation Vs">
            ...
            // <editor-fold defaultstate="collapsed" desc="DQ Transformation Is">
            Qdummy = _Q16ftoi(Iac[0]) - QoffsetI0;
            QIa = _Q16mac(Qdummy, QgainI0, 0);

            Qdummy = _Q16ftoi(Iac[1]) - QoffsetI1;
            QIb = _Q16mac(Qdummy, QgainI1, 0);

            QIc = -1*(QIa+QIb);
            //Vd= 2/3 (Va*sinwt   + Vb*sin(wt-2pi/3)  + Vc*sin(wt+2pi/3)
            QId = _Q16mac(QIa, _Q16sin(Qtheta), 0) + _Q16mac(QIb, _Q16sin(Qtheta - Qpi23), 0) + _Q16mac(QIc, _Q16sin(Qtheta + Qpi23), 0);
            QId = _Q16mac(QId, Q23, 0);

            //Vq= 2/3 (Va*coswt   + Vb*cos(wt-2pi/3)  + Vc*cos(wt+2pi/3)
            QIq = _Q16mac(QIa, _Q16cos(Qtheta), 0) + _Q16mac(QIb, _Q16cos(Qtheta - Qpi23), 0) + _Q16mac(QIc, _Q16cos(Qtheta + Qpi23), 0);
            QIq = _Q16mac(QIq, Q23, 0);
            // </editor-fold>
            ...
            // <editor-fold defaultstate="collapsed" desc="Phase Angle Caculation #1">
            QIin1 = Qomega;
//            QIin1 = _Q16ftoi(10*pi);
            ...
            // <editor-fold defaultstate="collapsed" desc="Z filter for D Voltage Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k)#2">
            ...
            // <editor-fold defaultstate="collapsed" desc="Z filter for D Current Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #3">
            QIin3 = _Q16mac(QId, Qa30, 0);
            QIout3 = _Q16mac(QIout_pre3, Qb30, QIin3);
            QIout_pre3 = QIout3;
            QIdf = QIout3;
            // </editor-fold>

            // <editor-fold defaultstate="collapsed" desc="Z filter for Q Current Y(k) = a0*Z^-1/(1-b0*Z^-1) U(k) #4">
            QIin4 = _Q16mac(QIq, Qa40, 0);
            QIout4 = _Q16mac(QIout_pre4, Qb40, QIin4);
            QIout_pre4 = QIout4;
            QIqf = QIout4;
            // </editor-fold>

            // <editor-fold defaultstate="collapsed" desc="Angle Calibration">
            QIdc = _Q16mac(QIdf, _Q16cos(QthetaC), 0) - _Q16mac(QIqf, _Q16sin(QthetaC), 0);
            QIqc = _Q16mac(QIqf, _Q16cos(QthetaC), 0) + _Q16mac(QIdf, _Q16sin(QthetaC), 0);
            // </editor-fold>

            // <editor-fold defaultstate="collapsed" desc="P & Q">
            Qdummy = _Q16mac(QVdf, QIdc, 0);
            QPower = _Q16mac(_Q16ftoi(1.5), Qdummy, 0);
//            Qdummy = 0 - _Q16mac(QVdf, QIqc, 0);
//            QReactive = _Q16mac(_Q16ftoi(1.5), Qdummy, 0);
            // </editor-fold>
