...
unsigned long Iac[3];              // Measured Currents
...
//    while (OSCCONbits.LOCK != 1);
    ...
    // <editor-fold defaultstate="collapsed" desc="Configure Timer 1 % 4"">
    T1CON = 0;          // Timer reset
    ...
    AD1CON1bits.SSRC = 0b111;       // PWM1 trigger
    AD1CON1bits.SSRCG = 0;          // PWM trigger
...
void Initialization(void)
{
    ...
    // <editor-fold defaultstate="collapsed" desc="Start Timer 1 & 4">
    TMR1 = 0;
    T1CONbits.TON = 1;
    TMR4 = 0;
    T4CONbits.TON = 1;
...
int main( void )
{
    ...
    _Q16 QP = _Q16ftoi(120); // PI controller P gain normalized to QoffsetVx = 120
    _Q16 QI = _Q16ftoi(14); // PI controller I gain normalized to QoffsetVx gain*T 28000*0.0005 = 14
    _Q16 Qomega = 0, Qomega_init = _Q16ftoi(120*pi); // freq rads/s;
    _Q16 QsampT0 = _Q16ftoi(0.5), QsampT = _Q16ftoi(0.5); // Sampling Time - 2kHz - 0.5ms

    //DQ Transformation V - Calibration done by Mike for PMU1 and Generic Control 1 on 03/29/2016
    _Q16 Qdummy = 0;
    _Q16 QoffsetV0 = _Q16ftoi(496), QoffsetV1 = _Q16ftoi(496), QoffsetV2 = _Q16ftoi(495);
    _Q16 QgainV0 = _Q16ftoi(0.91571365), QgainV1 = _Q16ftoi(0.864981592), QgainV2 = _Q16ftoi(0.881991219);
    ...
    // Damping Control #5
    _Q16 error5, Kp05, Qdamp = 0;


    //DQ Transformation I - Calibration done by Mike for PMU1 and Generic Control 1 on 3/29/2016
    _Q16 QoffsetI0 = _Q16ftoi(494), QoffsetI1 = _Q16ftoi(496);
    _Q16 QgainI0 = _Q16ftoi(0.0094375), QgainI1 = _Q16ftoi(0.00955414);
    _Q16 QIa,QIb,QIc = 0; // Three phase voltage
    _Q16 QId,QIq = 0; // DQ0 voltage
    _Q16 QIdp,QIqp = 0; // DQ0 voltage
    ...
    _Q16 Q30deg = _Q16ftoi(0.5236); // 1/380
    // </editor-fold>
    ...
    while(1)
    {
        if (flag_main)
        {
            ...
            dt2 = TMR4;
            TMR4 = 0;
            Qdummy = _Q16mac(_Q16ftoi(35000/35), QsampT0, 0);
            Qtest0 = Qdummy;
            QsampT = _Q16div(Qdummy,_Q16ftoi(1000));
            ...
            // <editor-fold defaultstate="collapsed" desc="Damping Control #5">
            error5 = speed_rads - _Q16ftoi(188.4956);
            Kp05 = _Q16ftoi(ref2);
            Qdamp = _Q16mac(Kp05, error5, 0);
            // </editor-fold>

            // <editor-fold defaultstate="collapsed" desc="Voltage Controller #4">
            Vref4 =  _Q16ftoi(ref1) + Qdamp;
            error4 = Vref4 - QVs;
            Kp04 = _Q16mac(_Q16ftoi(10), _Q16ftoi(0.01), 0);
            output4 = _Q16mac(Kp04, error4, 0);

            if (output4 > _Q16ftoi(6))
            {
                output4 = _Q16ftoi(6);
            }
            ...
            QIout0 = _Q16mac(QIin0, QI, QIout_pre0);         // I gain
            ...
            QIin1 = _Q16div(Qomega, _Q16ftoi(1000));
            ...
            QIdp = _Q16mac(QId, _Q16cos(Q30deg), 0) - _Q16mac(QIq, _Q16sin(Q30deg), 0);
...
//                QIdp = -1*QIdp;
            ...
            VIW[0] = ((QIdp+_Q16ftoi(2))*100)>>16;
            VIW[1] = QVs>>16;
            VIW[2] = (speed_rads*100)>>16;
