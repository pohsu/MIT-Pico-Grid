...
#define DAC_RESOLUTION_VOLT 1365
...
{
	DAC_PTR[1]->DACVALS.all = (Uint16) (( value / range + 1.5f ) * DAC_RESOLUTION_VOLT);
}

void DACB(float32 value, float32 range)
{
	DAC_PTR[2]->DACVALS.all = (Uint16) (( value / range + 1.5f ) * DAC_RESOLUTION_VOLT);
}

void DACC(float32 value, float32 range)
{
	DAC_PTR[3]->DACVALS.all = (Uint16) (( value / range + 1.5f )  * DAC_RESOLUTION_VOLT);
}	

void uDACA(float32 value, float32 range)
{
	DAC_PTR[1]->DACVALS.all = (Uint16) (value / range * DAC_RESOLUTION_VOLT);
}	

void uDACB(float32 value, float32 range)
{
	DAC_PTR[2]->DACVALS.all = (Uint16) (value / range * DAC_RESOLUTION_VOLT);
}	

void uDACC(float32 value, float32 range)
{
	DAC_PTR[3]->DACVALS.all = (Uint16) (value / range * DAC_RESOLUTION_VOLT);
}	
